...
INSERT INTO [Users].[dosen] ([id], [user_id], [nidn], [nama], [jk], [no_hp], [jurusan_id]) VALUES (N'6', N'46', N'2341234567', N'alkhoiri', N'L', N'087413432123', N'1')
GO
...
INSERT INTO [Users].[mahasiswa] ([id], [user_id], [nim], [nama], [jk], [kelas_id], [no_hp], [poin], [angkatan], [status]) VALUES (N'1', N'2', N'12345678', N'agus', N'L', N'5', N'087866711494', N'80', N'2023', N'1')
GO

INSERT INTO [Users].[mahasiswa] ([id], [user_id], [nim], [nama], [jk], [kelas_id], [no_hp], [poin], [angkatan], [status]) VALUES (N'8', N'50', N'1229321234', N'Breored', N'L', N'2', N'33333', N'0', N'2023', N'1')
GO
...
INSERT INTO [Users].[staff] ([id], [user_id], [nip], [nama], [jk], [no_hp], [prodi_id]) VALUES (N'4', N'49', N'0000000000', N'Ruru', N'L', N'08374332412', N'1')
GO
...
INSERT INTO [Users].[users] ([id], [username], [password], [role], [photo_path]) VALUES (N'46', N'dosen', N'$2y$10$spnnsYLlw5FcsvEZeYvswujuYpr29gPKrpqXhWbork0tVdWZC9tp2', N'3', NULL)
GO

INSERT INTO [Users].[users] ([id], [username], [password], [role], [photo_path]) VALUES (N'49', N'staff', N'$2y$10$xuS2rf9bmdJebTBT7dnXzOnm54Mg52PXnc0Ej5NBRseW7SD.4J31O', N'2', NULL)
GO

INSERT INTO [Users].[users] ([id], [username], [password], [role], [photo_path]) VALUES (N'50', N'mahasiswa', N'$2y$10$tqeHN1sh3qxPRsKIpd0zO.H/CLQQ8iW9Hezcz0jTbq1DPOLGd/Iki', N'4', NULL)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[Users].[dosen]', RESEED, 7)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[Users].[mahasiswa]', RESEED, 8)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[Users].[staff]', RESEED, 4)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[Users].[users]', RESEED, 50)
GO
