...
class StaffCotroller
{
    ...
    // public function getImageUpload($modelId, $modelName){
    //     $sql2 = "SELECT * FROM $this->tableUpload WHERE model_id = ? AND model_name = ?";
    //     $params = [$modelId, $modelName];
    
    //     $stmt = sqlsrv_query($this->conn, $sql2, $params);
