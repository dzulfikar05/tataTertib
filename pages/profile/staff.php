    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title modal-title-p">Form Staff</h5>
            ...
            <div class="modal-body m-3">
                <form id="p_form_dosen">
                    ...
                    <div class="col-12 row">
                        <label class="my-3 ">DATA  STAFF </label>
                        <div class="col-md-8">
                            <input type="hidden" id="p_id" name="id">
                            <input type="hidden" id="p_user_id" name="user_id">
                            <label class="required-label mb-1 d-none">NIP</label>
                            <div class="form-group mb-2 d-none">
                                <div class="form-line">
                                    <input type="text" class="form-control" id="p_nip" name="nip" maxlength="10" required />
                                </div>
                            </div>
                            ...
                            <label class="required-label mb-1 d-none">Prodi</label>
                            <div class="form-group mb-2 d-none">
                                <div class="form-line">
                                    <select class="form-control  prodi_id-select2 " style="width: 100%;" id="p_prodi_id" name="prodi_id" >
                                        <option value="">-- PILIH --</option>
                                    </select>
                                </div>
                            </div>
