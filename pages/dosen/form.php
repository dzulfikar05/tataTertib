                ...
                <form id="form_dosen">
                    ...
                    <div class="col-12 row">
                        ...
                        <div class="col-md-8">
                            ...
                            <label class="required-label mb-1">NIDN</label>
                            <div class="form-group mb-2">
                                <div class="form-line">
                            ...
                            <div class="form-group mb-2 ">
                                <div class="form-line">
                                    <select class="form-control  jurusan_id-select2 " style="width: 100%;" id="jurusan_id" name="jurusan_id" >
                            ...
                            <div class="form-group mb-2">
                                <div class="form-line " >
                                    <select type="text" class="form-control jk" style="width: 530px;" id="jk" name="jk">
